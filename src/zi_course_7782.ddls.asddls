...
@EndUserText.label: 'Data Definition for ZCOURSE_7782'
define root view entity ZI_COURSE_7782
as select from ZCOURSE_7782 as Course
composition [0..*] of ZI_SCHEDULE_7782 as _Schedule
association [0..1] to I_Currency as _Currency on
$projection.CurrencyCode = _Currency.Currency
association [0..1] to I_Country as _Country on $projection.Country
= _Country.Country
{
